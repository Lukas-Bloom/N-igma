...
export const levels = () => {
  ...
  [
    ...
    "#                                     -                                           b              D #",
    "#                                    ===             =                            =          677777#",
    "#                 K     E          gg       B^^^^2===+               -         U d           +55555#",
    "#   !           2==1   2==1       gg       2=====+555+        =     2=1      2=====          +     #",
    "#P P! -   J J   +3++ Y ++++      gg        ++55555   +        +     +++=     +55555          +     #",
    "#===4==1 2===1  ++:++:+++++    0gg         o$  d         8 ?  :  ?  +:++=             b - t  +44444#",
    "#+3+++++ +++++  +++++++¤+++=======     X=============  ====?==+  ?  +++++======wwwwwww!======+=====#",
    "#+++3+++ ++¤++  +++3++++++++3++:++      ++¤+:3++++++3  ++++?+++  ?  +:+++3+++:++++++++!++:+++++:++¤#",
    "#||||||||||||||||||||||||||||||||||||||||||||||||||||||||||?|||||?|||||||||||||||||||||||||||||||||#",
  ],
    ...
    [
      ...
      "#=1     2===========1      #                     x                                  #",
      "#++44444+++++3+++++++      #                                                        #",
      "#++44444555555555555+      #   2===========1                                        #",
      "#++wwwww==========14+      #   +55555555555+                                        #",
      "#+++3+++++++:++++++4+t     #   + 0      U J+                                        #",
      "#5555555555555555554++     #   +===1ggg2===+                           #            #",
      "# o        b   b   4++     #   ++5554445553+                       g   ##           #",
      "# 267777777777777777++677771   +: 8 444   ++g     #     g    #    g    ###          #",
      "#4++++++++++++++++++++++++++   ++   444   55g    g     g    g    g     ####         #",
      "#455555555555555555555555555   55444444444  g                          #####    D   #",
      "#=========£ 2=1  2====1 £======================1                       2=============",
      "#++:+++++Y 2+++==¤+++++1 E+3+++++++++++++++:++++1wwwwwwwwwwwwwwwwwwwwww++:++++++3++++",
      "#++++++++==+++++++++++++==++++++++++:+++++++++3++++++++++++++++:+++++++++++++++++++++",
      "#||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||",
    ],
    //4
